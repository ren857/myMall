...
public class MemberController {
	...
	private String generateJwtToken(Member member) {
		...
		return Jwts.builder().claim("mid", member.getMid()).setSubject(member.getLoginusername()) // 設置 JWT 主題為使用者名稱
	...
	public ResponseEntity<?> getCurrentUser(@RequestHeader("Authorization") String token) {
		try {
			...
			String username = Jwts.parser().setSigningKey("your-secret-key")
